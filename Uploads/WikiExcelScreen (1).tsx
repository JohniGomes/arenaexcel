            ...
            renderItem={({ item, index }) => (
              ...
              >
                ...
                <View style={styles.videoInfo}>
                  ...
                  <Text style={styles.videoSubtitulo}>Toque para assistir</Text>
                </View>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity style={styles.videoBanner} onPress={() => setTela('videos')} activeOpacity={0.85}>
        ...
        <View style={[styles.badge, { backgroundColor: '#E65100' }]}>
          <Text style={[styles.badgeTexto, { color: '#FFF' }]}>20</Text>
        </View>
        <Text style={[styles.cardSeta, { color: '#E65100', marginLeft: 8 }]}>›</Text>
      </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#1E88E5', paddingHorizontal: 20, paddingTop: 16, paddingBottom: 20 },
  ...
  videoBanner: {
    ...
    borderRadius: 14, padding: 16, borderLeftWidth: 5, borderLeftColor: '#E65100',
  ...
  videoBannerTitulo: { fontSize: 16, fontWeight: '700', color: '#E65100' },
  ...
  playBtn: { backgroundColor: '#E65100', borderRadius: 20, width: 28, height: 28, justifyContent: 'center', alignItems: 'center' },
