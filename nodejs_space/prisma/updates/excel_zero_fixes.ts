// Correções para EXCEL DO ZERO (Trilha 1)
// Q1-Q9: Adicionar spreadsheetContext HTML + dicas + corrigir validação

export const excelZeroUpdates = [
  {
    order: 1,
  ...
  },
  {
    ...
    // IMPORTANTE: Aceitar ambas =A1+B1 e =SOMA(A1,B1) como corretas
    // Isso já foi corrigido na validação do backend
  },
  {
    order: 8,
  ...
  },
  {
    ...
    // Essa questão será transformada em múltipla escolha já que é conceitual
  },
];
