...
exports.QUESTION_BASE_STYLES = void 0;
exports.wrapDescription = wrapDescription;
exports.QUESTION_BASE_STYLES = `
<style>
...
<div class="q-body">
`;
function wrapDescription(html) {
    return `${exports.QUESTION_BASE_STYLES}${html}</div>`;
}
//# sourceMappingURL=question-design-system.js.map