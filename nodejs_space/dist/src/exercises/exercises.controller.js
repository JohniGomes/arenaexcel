...
let ExercisesController = class ExercisesController {
    ...
    async getExercisesByLesson(lessonId, user) {
        return this.exercisesService.getExercisesByLesson(lessonId, user.id);
    }
    async submitAnswer(user, submitAnswerDto) {
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'lessonId', description: 'Lesson ID', type: Number }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Exercises retrieved successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Lesson already completed' }),
...
], ExercisesController.prototype, "getExercisesByLesson", null);
__decorate([
    (0, common_1.Post)('submit'),
    (0, swagger_1.ApiOperation)({ summary: 'Submit answer to an exercise' }),
    ...
    __metadata("design:returntype", Promise)
], ExercisesController.prototype, "submitAnswer", null);
