...
let BadgesController = class BadgesController {
    ...
    async imprimirCertificado(id, res) {
        const cert = await this.badgesService.validarCertificado(id);
        if (!cert) {
            return res.status(404).send(this.renderInvalidCertificate());
        }
...
<body>
  ...
  <p>Este certificado n\u00e3o existe ou foi removido.</p>
    ...
    renderCertificateTemplate(cert, nivelConfig, data, qrUrl) {
        const htmlTemplate = `
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
], BadgesController.prototype, "getMeusBadges", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], BadgesController.prototype, "verificarBadges", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Post)('certificado/gerar'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], BadgesController.prototype, "gerarCertificado", null);
__decorate([
    (0, common_1.Get)('certificado/validar/:id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Res)({ passthrough: false })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], BadgesController.prototype, "validarCertificado", null);
__decorate([
    (0, common_1.Get)('certificado/imprimir/:id'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Res)({ passthrough: false })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], BadgesController.prototype, "imprimirCertificado", null);
